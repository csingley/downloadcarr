...
import downloadcarr.models as models
...
def test_encode_datetime():
    ...
    encoded = models.base.encode_datetime(
        datetime(2020, 6, 5, 13, 38, 55, 123000, tzinfo=UTC)
    )
    assert encoded == "2020-06-05T13:38:55.123Z"
    ...
    encoded = models.base.encode_datetime(
        datetime(2020, 6, 5, 13, 38, 55, 123400, tzinfo=UTC)
    )
    assert encoded == "2020-06-05T13:38:55.1234Z"
...
def test_encode_time():
    ...
    # milliseconds
    encoded = models.base.encode_time(time(13, 38, 55, 123000))
    assert encoded == "13:38:55.123"
    ...
    # weird fractional seconds
    encoded = models.base.encode_time(time(13, 38, 55, 123400))
    assert encoded == "13:38:55.1234"
...
def test_encode_timedelta():
    ...
    encoded = models.base.encode_timedelta(
        timedelta(hours=13, minutes=38, seconds=55, milliseconds=123)
    )
    assert encoded == "13:38:55.123"

    # microseconds
    encoded = models.base.encode_timedelta(
        timedelta(hours=13, minutes=38, seconds=55, microseconds=123456)
    )
    assert encoded == "13:38:55.123456"

    # weird fractional seconds
    encoded = models.base.encode_timedelta(
        timedelta(hours=13, minutes=38, seconds=55, microseconds=123400)
    )
    assert encoded == "13:38:55.1234"
...
def test_decode_time():
    ...
    # weird fractional seconds
    decoded = models.base.decode_time(time, "13:38:55.1234")
    assert decoded == time(13, 38, 55, 123400)
